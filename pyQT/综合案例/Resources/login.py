...
"}")
        ...
        self.account_cb.setMinimumSize(QtCore.QSize(0, 35))
...
"}")
    ...
    def retranslateUi(self, Form):
        ...
        self.login_btn.setText(_translate("Form", "确认登录"))
        self.remember_pwd_cb.setText(_translate("Form", "记住密码"))
        self.account_cb.setItemText(0, _translate("Form", "23654123"))
        self.account_cb.setItemText(1, _translate("Form", "25412563"))
